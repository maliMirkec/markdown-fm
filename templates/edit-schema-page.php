...
<div class="wrap">
  <div class="markdown-fm-admin-container">
    <div class="markdown-fm-header">
      <div class="markdown-fm-header-content">
        ...
        <div class="markdown-fm-header-text">
          ...
          <p class="markdown-fm-tagline"><?php esc_html_e('Edit YAML schema for this template', 'markdown-fm'); ?></p>
        </div>
      </div>
    </div>
    ...
    <div class="markdown-fm-intro">
      ...
      <p><?php esc_html_e('Define the YAML schema that specifies which fields are available for this template.', 'markdown-fm'); ?></p>
    </div>
    ...
    <form method="post" action="">
      ...
      <div style="background: #fff; padding: 20px; border-radius: 8px; box-shadow: 0 1px 3px rgba(0,0,0,.1);">
        <p><?php esc_html_e('Enter your YAML schema below:', 'markdown-fm'); ?></p>
      ...
      <p class="submit" style="margin-top: 20px;">
        <button type="submit" class="button button-primary button-large">
          <?php esc_html_e('Save Schema', 'markdown-fm'); ?>
        </button>
